...
router.post('/clinical/lab-chef-note',           authorizeRoles([...CLINICAL_ROLES, 'dental', 'dentist', 'dental_tech', 'dental_hod', 'dental_lab_manager', 'dental_lab', 'deputy_coo']), clinicalAIController.generateLabChefNote);
...
const LUMINA_ROLES = [
  'admin', 'nurse', 'chef-nurse', 'doctor', 'medical_director',
