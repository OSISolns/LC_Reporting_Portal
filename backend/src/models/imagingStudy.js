  ...
  static async create(data, user) {
    ...
    const { rows } = await db.query(
      ...
      [
        ...
        typeof data.exam_type === 'object' && data.exam_type ? (data.exam_type.code || null) : (data.exam_type_loinc || (typeof data.exam_type === 'string' ? data.exam_type : null)),
        typeof data.exam_type === 'object' && data.exam_type ? (data.exam_type.display || data.exam_type.code || null) : (data.exam_type_display || null),
        data.sid || null,
