...
class Feedback {
  static async create(data) {
    const {
      ...
      laboratory, laboratoryResults, cafetaria, imaging, other, otherDetails, concernDescription
    } = data;
    ...
    const { rows } = await db.query(
      `INSERT INTO internal_feedbacks (
        ...
        laboratory, laboratory_results, cafetaria, imaging, other, other_details,
        concern_description
