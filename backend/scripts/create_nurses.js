...
const nurses = [
  ...
  { name: 'KAGOYIRE Diane', username: 'lc_diane_n', email: 'diane.n@legacyclinics.rw', role: 'nurse' },
  ...
  { name: 'UMUTESI Denyse', username: 'lc_denyse_n', email: 'denyse.n@legacyclinics.rw', role: 'nurse' },
  ...
  { name: 'BYUKUSENGE Claudine', username: 'lc_claudine_n', email: 'claudine.n@legacyclinics.rw', role: 'nurse' },
