  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { configKey: 'lab_archive', name: 'Document Archive', icon: <Archive size={18} />, path: '/lab/archive', requiredPerm: null, allowedRoles: ['lab_team_lead', 'lab_lead', 'lab_manager', 'lab_tech', 'lab', 'admin', 'coo', 'deputy_coo'] },
    ...
    },
    {
      ...
      items: [
        ...
        { configKey: 'roster_generator', name: 'Roster Generator', icon: <FileText size={18} />, path: '/roster-generator', requiredPerm: null, allowedRoles: ['admin', 'deputy_coo', 'coo', 'operations_staff', 'operations'] },
        { configKey: 'central_store', name: 'General Store Hub', icon: <Database size={18} />, path: '/central-store', requiredPerm: null, allowedRoles: ['admin', 'deputy_coo', 'coo', 'stock-manager'] },
        { configKey: 'master', name: 'Item Master', icon: <PackageCheck size={18} />, path: '/master', requiredPerm: null, allowedRoles: ['admin', 'deputy_coo', 'coo', 'stock-manager'] },
        ...
        { configKey: 'procurement', name: 'Procurement Hub', icon: <Building size={18} />, path: '/procurement', requiredPerm: null, allowedRoles: ['admin', 'procurement-manager', 'deputy_coo', 'coo'] },
        { configKey: 'supplier', name: 'Supplier Management', icon: <Building size={18} />, path: '/supplier-portal-manager', requiredPerm: null, allowedRoles: ['admin', 'procurement-manager', 'deputy_coo', 'coo'] },
      ]
    },
    ...
    },
    {
      ...
      items: [
        { configKey: 'daily_report', name: 'Daily Report', icon: <Activity size={18} />, path: '/nursing-hub/daily-report', requiredPerm: { mod: 'clinical_observation', act: 'view' }, allowedRoles: ['nurse', 'chef-nurse', 'deputy_chef_nurse', 'deputy-chef-nurse', 'deputy_chief_nurse', 'admin', 'coo', 'deputy_coo'] },
        ...
        { configKey: 'safety', name: 'Safety Workspace', icon: <PenTool size={18} />, path: '/safety-management', requiredPerm: { mod: 'incident_reports', act: 'approve' }, allowedRoles: ['hsfp', 'admin', 'deputy_coo', 'coo', 'medical_director', 'quality_manager', 'qm', 'quality_accreditation_officer'] },
        { configKey: 'risk', name: 'Risk Register', icon: <ShieldAlert size={18} />, path: '/risk-register', requiredPerm: { mod: 'incident_reports', act: 'approve' }, allowedRoles: ['hsfp', 'admin', 'deputy_coo', 'coo', 'medical_director', 'quality_manager', 'qm', 'quality_accreditation_officer'] },
