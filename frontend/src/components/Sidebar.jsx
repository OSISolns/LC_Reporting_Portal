...
const Sidebar = ({ onClose }) => {
  ...
  const menuItems = [
    ...
    { configKey: 'lab_hub',       name: 'Laboratory Hub',   icon: <FlaskConical size={20} />,    path: '/lab',          requiredPerm: null, allowedRoles: ['admin', 'deputy_coo', 'lab_team_lead', 'lab_lead', 'lab_manager', 'lab_tech', 'lab'] },
    ...
    { configKey: 'consumables',   name: 'Consumables Log',  icon: <ClipboardList size={20} />,   path: '/consumables-log', requiredPerm: null, allowedRoles: ['admin', 'deputy_coo', 'chef-nurse', 'deputy_chef_nurse', 'deputy-chef-nurse', 'deputy_chief_nurse', 'nurse', 'lab_team_lead', 'lab_lead', 'lab_manager', 'lab_tech', 'lab', 'dental', 'dentist', 'dental_tech', 'dental_hod', 'dental_lab_manager', 'imaging_tech', 'imaging_manager', 'sono', 'radiologist', 'physiotherapist', 'physio', 'physio_manager', 'operations_staff', 'coo', 'hsfp'] },
