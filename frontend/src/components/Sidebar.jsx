...
const Sidebar = ({ onClose }) => {
  ...
  const menuItems = [
    ...
    { configKey: 'lab_manager_dashboard', name: 'Lab Manager Dashboard', icon: <Activity size={20} />, path: '/lab-manager', requiredPerm: null, allowedRoles: ['admin', 'deputy_coo', 'coo', 'lab_team_lead', 'lab_lead', 'lab_manager', 'quality_manager', 'qm'] },
