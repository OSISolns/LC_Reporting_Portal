...
const Sidebar = ({ onClose }) => {
  ...
  const menuItems = [
    ...
    { configKey: 'daily_inventory', name: 'Daily Stock Checkup', icon: <PackageCheck size={20} />, path: '/nursing-hub/inventory', requiredPerm: { mod: 'clinical_observation', act: 'view' }, allowedRoles: ['admin', 'stock-manager'] },
