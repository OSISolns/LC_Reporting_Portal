  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { configKey: 'master', name: 'Item Master', icon: <PackageCheck size={18} />, path: '/master', requiredPerm: null, allowedRoles: ['admin', 'deputy_coo', 'stock-manager', 'procurement-manager'] },
