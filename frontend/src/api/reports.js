...
export const getReportSettings = () => api.get('/reports/settings');
export const updateReportSettings = (data) => api.put('/reports/settings', data);
...
export const getWeeklyReport = (startDate, endDate) => api.get(`/reports/weekly?startDate=${startDate}&endDate=${endDate}`);
