...
const SIDEBAR_ITEMS = [
  ...
  { key: 'safety',          name: 'Safety Workspace',    Icon: PenTool,         path: '/safety-management',        allowedRoles: ['hsfp','admin','deputy_coo'] },
  { key: 'risk',            name: 'Risk Register',       Icon: ShieldAlert,     path: '/risk-register',            allowedRoles: ['hsfp','admin','deputy_coo'] },
  { key: 'infection',       name: 'Infection Control',   Icon: Activity,        path: '/infection-control',        allowedRoles: ['hsfp','admin','deputy_coo'] },
