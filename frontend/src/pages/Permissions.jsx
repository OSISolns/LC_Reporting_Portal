...
const SIDEBAR_ITEMS = [
  ...
  { key: 'nursing_hub',     name: 'Nursing Hub',         Icon: Stethoscope,     path: '/nursing-hub',              allowedRoles: ['nurse','admin','chef-nurse','coo','deputy_coo'] },
  { key: 'doctor_hub',      name: 'Doctor Hub',          Icon: Stethoscope,     path: '/doctor-hub',               allowedRoles: ['doctor','consultant','admin','medical_director','coo','deputy_coo'] },
  { key: 'imaging',         name: 'Imaging Hub',         Icon: ScanLine,        path: '/imaging',                  allowedRoles: ['imaging_tech','imaging_manager','admin','medical_director','coo','deputy_coo'] },
  { key: 'lab_hub',         name: 'Laboratory Hub',      Icon: FlaskConical,    path: '/lab',                      allowedRoles: ['admin','deputy_coo','coo','lab_team_lead','lab_tech','lab'] },
  { key: 'dental_hub',      name: 'Dental Hub',          Icon: Heart,           path: '/dental',                   allowedRoles: ['admin','deputy_coo','coo','dental','dentist','dental_tech','dental_hod','dental_lab_manager'] },
  { key: 'physio_hub',      name: 'Physio Hub',          Icon: Dumbbell,        path: '/physio',                   allowedRoles: ['admin','deputy_coo','coo','physiotherapist','physio','physio_manager'] },
  { key: 'operations_hub',  name: 'Operations Hub',      Icon: Settings,        path: '/operations',               allowedRoles: ['admin','deputy_coo','operations_staff','coo'] },
  { key: 'central_store',   name: 'General Store',       Icon: Database,        path: '/central-store',            allowedRoles: ['admin','deputy_coo','coo','stock-manager'] },
  { key: 'master',          name: 'Master Module',       Icon: Database,        path: '/master',                   allowedRoles: ['admin','stock-manager','coo','deputy_coo'] },
  { key: 'procurement',     name: 'Procurement Hub',     Icon: Building,        path: '/procurement',              allowedRoles: ['admin','procurement-manager','deputy_coo','coo'] },
  { key: 'supplier',        name: 'Supplier Portal',     Icon: Building,        path: '/supplier-portal-manager',  allowedRoles: ['admin','procurement-manager','deputy_coo','coo'] },
  { key: 'daily_report',    name: 'Daily Report',        Icon: Activity,        path: '/nursing-hub/daily-report', allowedRoles: ['nurse','chef-nurse','admin','coo','deputy_coo'] },
  ...
  { key: 'clinical_sheets', name: 'Clinical Sheets',     Icon: FileText,        path: '/clinical-sheets',          allowedRoles: ['nurse','admin','doctor','consultant','chef-nurse','medical_director','coo','deputy_coo'] },
  ...
  { key: 'compliance',      name: 'Compliance',          Icon: ShieldCheck,     path: '/compliance',               allowedRoles: ['admin','hsfp','coo','deputy_coo'] },
  ...
  { key: 'roster_generator', name: 'Roster Generator',   Icon: FileText,        path: '/roster-generator',         allowedRoles: ['admin','deputy_coo','coo','operations_staff','operations'] },
