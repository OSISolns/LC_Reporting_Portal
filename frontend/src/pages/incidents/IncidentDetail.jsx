  ...
  return (
    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '2.5rem' }}>
        <h1 style={{ fontSize: '2.25rem', fontWeight: 700, color: 'var(--primary-dark)', marginBottom: '0.5rem' }}>Incident #{data.id}</h1>
        <p style={{ color: 'var(--text-secondary)', fontSize: '1rem' }}>Historical record of a reported quality or safety event.</p>
      </div>
